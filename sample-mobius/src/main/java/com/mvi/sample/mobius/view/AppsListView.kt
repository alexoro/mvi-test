package com.mvi.sample.mobius.view
...
import com.mvi.sample.mobius.R
import com.mvi.sample.mobius.feature.AppsListEvents
...
class AppsListView(
    ...
    private val view = stubContainer.let {
        it.layoutResource = R.layout.mobius_main_content
        it.inflate()
    }
